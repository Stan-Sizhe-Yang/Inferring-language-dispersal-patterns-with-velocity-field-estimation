...
**3.  Supplementary_Materials：R_package_and_tutorial_of_LVF: The R package namely LVF and the tutorial for its implementaion.**
  
&emsp;&emsp;The detailed information can be found in README within this file.  
